...
(function( root, factory ) {
	...
	function setupDOM() {
		...
		createSingletonNode( dom.wrapper, 'aside', 'controls',
            ...
            '<div class="toggleOverview"><div id="a"></div></div>' );
        ...
        dom.controlsOverview = toArray( document.querySelectorAll( '.toggleOverview' ) );
	...
	function addEventListeners() {
		...
		pointerEvents.forEach( function( eventName ) {
            ...
            dom.controlsOverview.forEach( function( el ) { el.addEventListener( eventName, onNavigateOverviewClicked, false ); } );   
		} );
	...
	function removeEventListeners() {
		...
		[ 'touchstart', 'click' ].forEach( function( eventName ) {
            ...
            dom.controlsOverview.forEach( function( el ) { el.removeEventListener( eventName, onNavigateOverviewClicked, false ); } );
		} );
...
//		 the browsers default behavior
		...
		// ESC or O key
		else if ( ( event.keyCode === 13 || event.keyCode === 79 ) && features.transforms3d ) {
			if( dom.overlay ) {
				closeOverlay();
			}
			else {
    ...
    function onNavigateOverviewClicked( event ) { event.preventDefault(); onUserInput(); toggleOverview(); }
	...
	Reveal = {
        ...
        navigateOverview: toggleOverview,
